...
export const NIGHTS_CATEGORIES: string = `${BASE_URL}nights/categories`
export const FOODS_CATEGORIES: string = `${BASE_URL}foods/categories`
export const EXCURSION_CATEGORIES: string = `${BASE_URL}excursions/categories`
